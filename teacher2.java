...
class employeee extends people{
	int empid;
	String companyname;
	String qualification;
	int salary;
	employeee(String pname,String pgender,String paddress,int page,int eempid,String ecompanyname,String equalification,int esalary){
...
public class teacher2 extends employeee {
	String subject;
	String department;
	int teacherid;
